...
# :lucide-wrench: Preferences

If you applied policies and any of the following are already disabled, ignore it.
...
- Block the permission at `chrome://settings/content/protectedContent`
